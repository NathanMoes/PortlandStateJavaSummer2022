...
public class PhoneCallTest {
  ...
  */
  ...
  void testForGetCalleeNumberNonDefault(){
    PhoneCall call = new PhoneCall("Name is", "222-222-2222", "333-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
  ...
  void testTooFewDashes(){
    PhoneCall call = new PhoneCall("Name is","2221222-2222", "333-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
  ...
  void testTooFewDashesCallee(){
    PhoneCall call = new PhoneCall("Name is","222-222-2222", "3331333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
  ...
  void testTooFewNumbers(){
    PhoneCall call = new PhoneCall("Name is","222-222-2222", "aaa-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
    assertThat(call.getCalleeNumber(), is(nullValue()));
  }
  ...
  void testTooFewNumbersCaller(){
    PhoneCall call = new PhoneCall("Name is","bbb-222-2222", "123-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
    assertThat(call.getCallerNumber(), is(nullValue()));
  }
  ...
  void TestInvalidMinute(){
    PhoneCall call = new PhoneCall("Name is", "222-222-2222", "333-333-3333", "01/01/1000 10:3a", "01/01/1000 11:30");
  ...
  void TestInvalidMinuteEnd(){
    PhoneCall call = new PhoneCall("Name is", "222-222-2222", "333-333-3333", "01/01/1000 10:30", "01/01/1000 11:3a");
  ...
  */
  ...
  void testInvalidCalleeName(){
    PhoneCall call = new PhoneCall("bob robert", "222-222-2222", "333-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
  ...
  void testTooManyDashes(){
    PhoneCall call = new PhoneCall("Name is", "222----2222", "333-333-3333", "01/01/1000 10:30", "01/01/1000 11:30");
    assertThat(call.getCallerNumber(), is(nullValue()));
  }
  ...
  void testJavaDateValidIsValid(){
    PhoneCall call = new PhoneCall("Name is", "222-211-2222", "333-333-3333", "01/01/1000 10:30 am", "01/01/1000 11:30 am");
  ...
  void testComparePhoneCall(){
    PhoneCall call = new PhoneCall("Name is",  "222-211-2222", "333-333-3333", "01/01/1000 10:30 am", "01/01/1000 11:30 am");
    PhoneCall call1 = new PhoneCall("Name is", "222-211-2222", "333-333-3333", "01/01/1000 10:10 am", "01/01/1000 11:30 am");
  ...
  void testCompareDatesSameButNumberDifferent(){
    PhoneCall call = new PhoneCall("Name is",  "333-211-2222", "333-333-3333", "01/01/1000 10:30 am", "01/01/1000 11:30 am");
    PhoneCall call1 = new PhoneCall("Name is", "222-211-2222", "333-333-3333", "01/01/1000 10:30 am", "01/01/1000 11:30 am");
